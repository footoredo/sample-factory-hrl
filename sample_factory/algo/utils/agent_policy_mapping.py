...
class MultiAgentPolicyMapping:
    ...
    def __init__(self, cfg: Config, env_info: EnvInfo):
        ...
        assert self.num_policies == self.num_agents
        assert self.mix_policies_in_one_env
    ...
    def get_policy_for_agent(self, agent_idx: int, env_idx: int, global_env_idx: int) -> int:
        ...
        self.env_policies[env_idx] = [idx for idx in range(self.num_agents)]
